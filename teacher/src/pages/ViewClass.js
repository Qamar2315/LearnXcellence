    ...
    return (
        <>
            ...
            <Link to={'/studentDashboard'}>
                <button className="text-blue-500 hover:text-blue-600 text-lg font-semibold px-4">back</button>
            </Link>
            {
                viewClass &&
                <div>
                    ...
                    <div className='w-11/12'>
                        <div className="flex justify-between pl-4 pr-4">
                            <div className="text-left">
                                <h5 className="text-gray-700 font-semibold">Project start date: {viewClass.projectStartDate}</h5>
                                <h5 className="text-gray-700 font-semibold">Project end date: {viewClass.projectEndDate}</h5>
                            </div>
                            <div className="text-left">
                                <h5 className="text-gray-700 font-semibold">Viva start date: {viewClass.vivaStartDate}</h5>
                                <h5 className="text-gray-700 font-semibold">Viva end date: {viewClass.vivaStartDate}</h5>
                            </div>
                        </div>
                        ...
                        {
                            viewClass && viewClass.projects.length > 0 &&
                            <div className="h-96 bg-white rounded-lg overflow-y-auto p-4 scrollbar-thin scrollbar-thumb-pink-500 scrollbar-track-pink-100">
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    {viewClass.projects.map((project, index) => (
                                        <Link to={`/viewclass/${viewClass._id}/project/${project._id}`}>
                                            <div className="bg-white rounded-lg shadow-md p-6 w-full hover:shadow-lg">
                                                <div className="flex items-center justify-between mb-4">
                                                    ...
                                                    {
                                                        project.status.status === "disapproved" &&
                                                ...
                                                <div className="mb-4">
                                                    <p className="text-gray-600 text-sm font-semibold">Project Leader:</p>
